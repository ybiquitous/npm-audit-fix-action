...
- **deps:** bump @actions/github from 9.0.0 to 9.1.0 ([#1201](https://github.com/ybiquitous/npm-audit-fix-action/issues/1201)) ([d7dbb3c](https://github.com/ybiquitous/npm-audit-fix-action/commit/d7dbb3cad8db1cb847548c7dd74a3f95abd4c387))
- **deps:** bump undici from 6.23.0 to 6.24.1 ([#1179](https://github.com/ybiquitous/npm-audit-fix-action/issues/1179)) ([8b39c88](https://github.com/ybiquitous/npm-audit-fix-action/commit/8b39c88d98887eeedede9f6835a48a0689aa5aac))

## [7.3.6](https://github.com/ybiquitous/npm-audit-fix-action/compare/v7.3.5...v7.3.6) (2026-02-03)

### Bug Fixes

- **deps:** bump @actions/core from 2.0.2 to 3.0.0 ([#1167](https://github.com/ybiquitous/npm-audit-fix-action/issues/1167)) ([ac02097](https://github.com/ybiquitous/npm-audit-fix-action/commit/ac020976e4915524129d725ba6b707db9b22af92))
- **deps:** bump @actions/exec from 2.0.0 to 3.0.0 ([#1166](https://github.com/ybiquitous/npm-audit-fix-action/issues/1166)) ([3a89ecb](https://github.com/ybiquitous/npm-audit-fix-action/commit/3a89ecb2576f5ff050a13095b7b8d1826c35d1fa))
- **deps:** bump @actions/github from 8.0.0 to 9.0.0 ([#1168](https://github.com/ybiquitous/npm-audit-fix-action/issues/1168)) ([66104d3](https://github.com/ybiquitous/npm-audit-fix-action/commit/66104d33584ddbe4fb3040d71b2f3454718d6038))
...
- **deps:** bump @actions/core from 2.0.1 to 2.0.2 ([#1153](https://github.com/ybiquitous/npm-audit-fix-action/issues/1153)) ([00ddad9](https://github.com/ybiquitous/npm-audit-fix-action/commit/00ddad961091208b2f9f6e81c63c2976125eb040))
- **deps:** bump @actions/github from 6.0.1 to 7.0.0 ([#1152](https://github.com/ybiquitous/npm-audit-fix-action/issues/1152)) ([f16429d](https://github.com/ybiquitous/npm-audit-fix-action/commit/f16429dc410cd7638b6ff49d1ce6a134c2b497ff))
